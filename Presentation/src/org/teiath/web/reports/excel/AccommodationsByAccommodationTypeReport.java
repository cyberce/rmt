...
public class AccommodationsByAccommodationTypeReport {

	public HSSFWorkbook exportList(AccommodationsExcelService accommodationsExcelService, int accommodationTypeId) {
		HSSFWorkbook wb = new HSSFWorkbook();
		int rowDataIndex = 1;
		int rowIndex = 1;

		HSSFSheet sheet = wb.createSheet("Φοιτητικές Στέγες ανά Τύπο Κατοικίας");
		...
		try {
			Collection<Accommodation> accommodations = accommodationsExcelService
					.getAccommodationsByAccommodationType(accommodationTypeId);
